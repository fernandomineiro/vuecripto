    ...
    <md-toolbar md-elevation="0" class="md-transparent md-toolbar-absolute">
      <div class="md-toolbar-row md-offset">
        ...
        <div class="md-toolbar-section-end">
          ...
          >
            <md-list>
              <md-list-item :href="companyUrl" target="_blank">
...
export default {
  ...
  computed: {
    companyUrl() {
      return process.env.VUE_APP_COMPANY_URL;
    },
    setBgImage() {
      let images = {
        Pricing: "./img/1.jpg",
    ...
    getPageTitle() {
      return this.$t("pages." + this.$route.name);
    }
  },
  methods: {
    toggleSidebarPage() {
    ...
    showDialogForOpenApp() {
      const route = this.$router.currentRoute.path;
      this.appModal.showModal =
        this.$device === "mobile" && route !== "/register";
    }
  },
  created() {
    this.showDialogForOpenApp();
  },
  mounted() {
